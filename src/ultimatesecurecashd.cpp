...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        {
            // First part of help message is specific to ultimatesecurecashd / RPC client
            std::string strUsage = _("UltimateSecureCash version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  ultimatesecurecashd [options]                     " + "\n" +
                  "  ultimatesecurecashd [options] <command> [params]  " + _("Send command to -server or ultimatesecurecashd") + "\n" +
                  "  ultimatesecurecashd [options] help                " + _("List commands") + "\n" +
                  "  ultimatesecurecashd [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "ultimatesecurecash:"))
                fCommandLine = true;
...
int main(int argc, char* argv[])
{
    ...
    // Connect ultimatesecurecashd signal handlers
    noui_connect();
