...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(USC);
    unitlist.append(mUSC);
    unitlist.append(uUSC);
    unitlist.append(sUSC);
    return unitlist;
}
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case mUSC: return 100000;
    case uUSC: return 100;
    case sUSC: return 1;
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case USC: return 8; // 21,000,000 (# digits, without commas)
    case mUSC: return 11; // 21,000,000,000
    case uUSC: return 14; // 21,000,000,000,000
    case sUSC: return 16; // 2,100,000,000,000,000
    default: return 0;
    }
}
